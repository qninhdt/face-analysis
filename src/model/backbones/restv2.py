...
# ------------------------------------------------------------
"""
tiny(pretrained=False, **kwargs):  # 82.3|4.7G|24M -> |3.92G|30.37M   4.5G|30.33M
    embed_dims=[96, 192, 384, 768], depths=[1, 2, 6, 2]

small(pretrained=False, **kwargs):  # 83.6|7.0G|35M   -> |5.78G|40.94M
    embed_dims=[96, 192, 384, 768], depths=[1, 2, 12, 2]

base(pretrained=False, **kwargs):  # 84.4|10.2G|52M -> |7.25G|55.75M
    model = ResTV2(embed_dims=[96, 192, 384, 768], depths=[1, 3, 16, 3]

large(pretrained=False, **kwargs):  # 85.3|39.6|218M -> |14.09G|98.61M
    num_heads=[2, 4, 8, 16], embed_dims=[128, 256, 512, 1024], depths=[2, 3, 16, 2]
"""
...
class ResTV2(nn.Module):
    def __init__(self, depths=(2, 2, 2, 2), embed_dims=(96, 192, 384, 768),
        ...
        self.stem = ConvStem(3, embed_dims[0], patch_size=4)
